...
import com.android.rs.image.levels_relaxedBitCode;

/**
 * @hide
 */
public class ScriptC_levels_relaxed extends ScriptC {
    private static final String __rs_resource_name = "levels_relaxed";
    // Constructor
    public  ScriptC_levels_relaxed(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              levels_relaxedBitCode.getBitCode32(),
              levels_relaxedBitCode.getBitCode64());
