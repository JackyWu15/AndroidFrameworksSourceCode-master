...
import com.android.rs.image.fisheye_approx_fullBitCode;

/**
 * @hide
 */
public class ScriptC_fisheye_approx_full extends ScriptC {
    private static final String __rs_resource_name = "fisheye_approx_full";
    // Constructor
    public  ScriptC_fisheye_approx_full(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              fisheye_approx_fullBitCode.getBitCode32(),
              fisheye_approx_fullBitCode.getBitCode64());
