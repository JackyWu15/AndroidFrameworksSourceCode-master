...
import com.android.rs.image.fisheye_fullBitCode;

/**
 * @hide
 */
public class ScriptC_fisheye_full extends ScriptC {
    private static final String __rs_resource_name = "fisheye_full";
    // Constructor
    public  ScriptC_fisheye_full(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              fisheye_fullBitCode.getBitCode32(),
              fisheye_fullBitCode.getBitCode64());
