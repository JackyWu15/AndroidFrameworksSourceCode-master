 ...
 * The source Renderscript file: K:\\AndroidFrameworksSourceCode-master\\rs\\java\\tests\\ImageProcessing\\src\\com\\android\\rs\\image\\vignette_approx_full.rs
 */
...
import com.android.rs.image.vignette_approx_fullBitCode;

/**
 * @hide
 */
public class ScriptC_vignette_approx_full extends ScriptC {
    private static final String __rs_resource_name = "vignette_approx_full";
    // Constructor
    public  ScriptC_vignette_approx_full(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              vignette_approx_fullBitCode.getBitCode32(),
              vignette_approx_fullBitCode.getBitCode64());
