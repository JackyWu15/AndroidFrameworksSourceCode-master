...
import com.android.rs.image.vignette_relaxedBitCode;

/**
 * @hide
 */
public class ScriptC_vignette_relaxed extends ScriptC {
    private static final String __rs_resource_name = "vignette_relaxed";
    // Constructor
    public  ScriptC_vignette_relaxed(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              vignette_relaxedBitCode.getBitCode32(),
              vignette_relaxedBitCode.getBitCode64());
