 ...
 * The source Renderscript file: K:\\AndroidFrameworksSourceCode-master\\rs\\java\\tests\\ImageProcessing\\src\\com\\android\\rs\\image\\fisheye_relaxed.rs
 */

package com.android.rs.image;

import com.android.rs.image.fisheye_relaxedBitCode;

/**
 * @hide
 */
public class ScriptC_fisheye_relaxed extends ScriptC {
    private static final String __rs_resource_name = "fisheye_relaxed";
    // Constructor
    public  ScriptC_fisheye_relaxed(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              fisheye_relaxedBitCode.getBitCode32(),
              fisheye_relaxedBitCode.getBitCode64());
