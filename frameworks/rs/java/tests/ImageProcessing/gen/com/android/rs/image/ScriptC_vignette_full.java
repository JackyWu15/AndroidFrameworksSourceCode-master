 ...
 * The source Renderscript file: K:\\AndroidFrameworksSourceCode-master\\rs\\java\\tests\\ImageProcessing\\src\\com\\android\\rs\\image\\vignette_full.rs
 */

package com.android.rs.image;

import com.android.rs.image.vignette_fullBitCode;

/**
 * @hide
 */
public class ScriptC_vignette_full extends ScriptC {
    private static final String __rs_resource_name = "vignette_full";
    // Constructor
    public  ScriptC_vignette_full(RenderScript rs) {
        super(rs,
              __rs_resource_name,
              vignette_fullBitCode.getBitCode32(),
              vignette_fullBitCode.getBitCode64());
