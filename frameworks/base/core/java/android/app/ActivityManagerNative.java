...
class ActivityManagerProxy implements IActivityManager
    ...
    public int startActivity(IApplicationThread caller, String callingPackage, Intent intent,
        ...
        data.writeStrongBinder(caller != null ? caller.asBinder() : null);//caller指向Laucher的ApplicationThread
        data.writeString(callingPackage);
        intent.writeToParcel(data, 0);//intent包含启动组件MainActivity的信息
        data.writeString(resolvedType);
        data.writeStrongBinder(resultTo);//resultTo指向AMS内部的一个ActivityRecord
