...
public final class ActivityThread {
    ...
    private class ApplicationThread extends ApplicationThreadNative {
        ...
        //保存Activity的相关信息到本地，发送开启Activity的消息
        ...
        //绑定Application，同时创建了Instrumentation
    ...
    private Activity performLaunchActivity(ActivityClientRecord r, Intent customIntent) {
        ...
        try {
            ...
            //这个token是一个binder，指向了服务端的ActivityRecord，上面说过，他们作用相同，一个在客户端，一个在服务端
    ...
    private void handlePauseActivity(IBinder token, boolean finished,
            boolean userLeaving, int configChanges, boolean dontReport) {
        //ActivityThread被当成客户端，而每个Activity都用ActivityClientRecord来记录信息，对应服务端AMS的ActivityRecord
        ...
        if (r != null) {
            ...
            //上面3件事执行完成，通知AMS暂停已执行完毕，可以开始下一个activity了
            if (!dontReport) {
                try {
    ...
    private void handleBindApplication(AppBindData data) {
        ...
        if (data.instrumentationName != null) {
            ...
            mInstrumentation = new Instrumentation();//后期activity生命周期都通过其代理调用
        }
