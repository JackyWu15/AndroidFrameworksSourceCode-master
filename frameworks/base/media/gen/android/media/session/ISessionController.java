 ...
 * Original file: K:\\AndroidFrameworksSourceCode-master\\base\\media\\java\\android\\media\\session\\ISessionController.aidl
 */
...
@Override public void sendCommand(java.lang.String command, android.os.Bundle args, android.os.ResultReceiver cb) throws android.os.RemoteException
{
...
@Override public void registerCallbackListener(android.media.session.ISessionControllerCallback cb) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void rate(android.media.Rating rating) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
