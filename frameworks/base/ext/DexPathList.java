...
/*package*/ final class DexPathList {
    ...
    private final ClassLoader definingContext;//类加载器
     ...
     */
    private Element[] dexElements;//Element数组
    ...
    DexPathList(ClassLoader definingContext, String dexPath,
        ...
        this.definingContext = definingContext;//初始化类加载器
    ...
    private static Element[] makeDexElements(List<File> files, File optimizedDirectory,
      ...
      for (File file : files) {
          if (file.isDirectory()) {
              ...
              DexFile dex = null;
              if (name.endsWith(DEX_SUFFIX)) {//文件是否.dex结尾
                  // Raw dex file (not inside a zip/jar).
                  try {
                      //如果是.dex文件结尾，则构建成一个DexFile对象
    ...
    /*package*/ static class Element {
        ...
        public Class<?> findClass(String name, ClassLoader definingContext,
            ...
            //实际通过DexFile类的loadClassBinaryName进行查找，而DexFile最终会调用defineClassNative方法，通过c层处理返回class
